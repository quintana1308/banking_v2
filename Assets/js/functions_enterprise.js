    ...
    let tableEnterprise = $('#enterprise-list-table').dataTable( { 
        ...
        "columns":[
            ...
            {"data":"name"},
            {
                "data":"bd",
                "render": function(data, type, row) {
                    return `<span class="enterprise-bd">${data}</span>`;
                }
            },
            {"data":"rif"},
            {
                "data":"token",
                "render": function(data, type, row) {
                    return `<span class="enterprise-token">${data}</span>`;
                }
            },
            {
                "data":"table",
                "render": function(data, type, row) {
                    return `<span class="enterprise-table">${data}</span>`;
                }
            },
            {
                "data": "id",
                "render": function(data, type, row) {
                    ...
                    html += `<div class="d-flex align-items-center justify-content-center">
                                 <a class="btn-action btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar" href="${base_url}/enterprise/edit/${data}">
