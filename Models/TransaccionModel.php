<?php
	...
	private function evaluarCoincidenciaFecha($fechaRecibida, $fechaBD) {
    	...
    	$fechaActual = date('Y-m-d H:i:s');
    	$logEntry = "$fechaActual - antes: fecha_Recibida:" . $fechaRecibida . " - fechaBD:" . $fechaBD . "\n";
    	file_put_contents($logFile, $logEntry, FILE_APPEND);
		...
		$logFile = 'evaluacion_fecha.log';
    	$fechaActual = date('Y-m-d H:i:s');
    	$logEntry = "$fechaActual - despues: fecha_Recibida:" . $fechaFormateada . " - fechaBD:" . $fechaBDFormateada . "\n";
    	file_put_contents($logFile, $logEntry, FILE_APPEND);
